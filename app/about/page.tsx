...
export default function AboutPage() {
  const stats = [
    { number: "10+", label: "Years of Combined Experience", icon: <Calendar className="w-6 h-6" /> },
    { number: "300+", label: "Projects Completed", icon: <Award className="w-6 h-6" /> },
    { number: "10+", label: "Skilled Craftsmen", icon: <Users className="w-6 h-6" /> },
    { number: "3", label: "Locations Served", icon: <Globe className="w-6 h-6" /> },
  ]
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative py-24 bg-gradient-to-br from-primary/5 to-accent/5">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6 text-balance">About ModuLux</h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold text-foreground mb-6 text-balance">Our Achievements</h2>
            <p className="text-xl text-muted-foreground text-pretty">
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold text-foreground mb-6 text-balance">Our Core Values</h2>
          </motion.div>
