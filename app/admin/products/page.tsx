      ...
      <div className="flex items-center justify-between mb-6 gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <SaveForm action={seedDefaults}>
            <SubmitButton confirm="Seed default products? This will add missing default categories if they don't exist." className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-border/50 text-sm transition-all duration-200 ease-out transform hover:shadow-md hover:-translate-y-[1px]">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <SaveForm action={deleteProduct}>
                  ...
                  <SubmitButton
                    type="danger"
                    confirm={`Are you sure you want to delete "${p.name}"? This action cannot be undone.`}
